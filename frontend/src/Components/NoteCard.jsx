...
//       return;
//     }
//     onSummarize?.(note); // pass whole note so caller has id + current data
//   };
...
//         {/* Content Preview */}
//         <div
//           className="prose dark:prose-invert max-w-none text-gray-700 dark:text-gray-700 line-clamp-4 text-sm leading-relaxed"
...
//             }`}
//             aria-label={`Pin/unpin note: ${note.title}`}
//           >
//             <Pin size={14} />
...
//             }`}
//             aria-label={`Favorite/unfavorite note: ${note.title}`}
//           >
...
//               className="font-medium inline-flex items-center gap-1 text-green-500 hover:text-green-600"
//               aria-label={`${
//                 showSummary ? "Hide" : "Show"
//               } summary for note: ${note.title}`}
//             >
//               <Sparkles size={14} />
...
// /* Small inline star icon component so we can fill when active */
...
//   onToggleFavorite,
//   onSummarize,
//   onView,        // <-- NEW PROP for viewing note
//   darkMode,
// }) => {
//   const [showSummary, setShowSummary] = useState(false);
...
//           <button
//           onClick={() => onView?.(note)}
//           className="font-medium inline-flex items-center gap-1 text-purple-500 hover:text-purple-600"
//           >
//            <Eye size={14} />
//            View
//           </button>
...
//               onClick={toggleSummaryView}
//               className="font-medium inline-flex items-center gap-1 text-green-500 hover:text-green-600"
//               aria-label={`${showSummary ? "Hide" : "Show"} summary for note: ${note.title}`}
//             >
//               <Sparkles size={14} />
//               {showSummary ? "Hide Summary" : "Show Summary"}
//             </button>
...
// /* Small inline star icon component */
// const StarIcon = ({ active }) => (
//   <Star
//     size={14}
//     className={active ? "text-yellow-500" : ""}
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Actions - Single Row, Small Buttons */}
